...
export const Publish = ({ initialData }: PublishProps) => {
  ...
  const onPublish = () => {
    ...
    const promis = update({ id: initialData._id, isPublish: true }).finally(
  ...
  const onUnPublish = () => {
    ...
    const promis = update({ id: initialData._id, isPublish: false }).finally(
      () => setIsSubmiting(false)
    );
    ...
    toast.promise(promis, {
      ...
      error: "Failed to unpunlish note",
    });
  };
